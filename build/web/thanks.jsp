...
<%-- 
    Document   : thanks
    Created on : Apr 27, 2022, 3:08:54 PM
    Author     : toten
--%>
...
<html lang="en">
    <html lang="zxx" class="no-js">
        ...
        <body>
                    ...
                    <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                        <div class="col-first">
                            ...
                            <nav class="d-flex align-items-center">
                                <a href="welcome">Home<span class="lnr lnr-arrow-right"></span></a>
                                <a href="home">Shop<span class="lnr lnr-arrow-right"></span></a>
                                <a href="thanks.jsp">Thank you</a>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <!-- Section -->
            <section class="py-5">
                <div class="container d-flex  justify-content-center align-items-center" style="height: 300px; flex-direction: column">
                    <h1 class="text-center" >Order Successfully. Thanks you very much.....</h1>

                    <a type="button" class="btn btn-outline-dark" style="padding: 10px 90px; margin-top: 30px; background: orange; border: orange" href="welcome">Home</a>
                </div>
            </section>
