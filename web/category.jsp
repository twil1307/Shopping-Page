            ...
            <div class="row">
                            ...
                            <c:forEach items="${listCategory}" var="D">
                                <li class="main-nav-list">
                                    <a href="filter-category?categoryId=${D.categoryID}" class="${D.categoryID==categoryIDFilter?"active bg-warning":""}" aria-expanded="false" aria-controls=""><span
                                            <img src="../../../../C:/Users/toten/AppData/Local/Temp/images.jpg" alt=""/>
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <div class="filter-bar d-flex flex-wrap align-items-center">
                        <div class="sorting">
                            <img src="../../../../C:/Users/toten/AppData/Local/Temp/17358882_429351444069574_1726696458036082734_o.jpg" alt=""/>
                                    ...
                                    <div class="single-product">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="prd-bottom">
                                                ...
                                                <c:choose>
                                                    <c:when test="${(sessionScope.account.role) == 'ADMIN'}">
                                                        <a href="delete-product?id=${D.productID}" class="social-info">
                                                            <span class="ti-close" style="cursor: pointer"></span>
                                                            <p class="hover-text" style="cursor: pointer">Delete</p>
                                                        </a>
                                                        <!--  -->
                                                        <a href="update-product?id=${D.productID}" class="social-info" >
                                                            <span class="ti-more" style="cursor: pointer"></span>
                                                            <p class="hover-text" style="cursor: pointer">Update</p>
                                                        </a>
...
<!--        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Select "Yes" below if you are really want to delete this product.</div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                        <a class="btn btn-primary getId"  href="delete-product?id=${D.productID}" style="background: orange; border: orange">Yes</a>
                    </div>
                </div>
            </div>
        </div>-->
