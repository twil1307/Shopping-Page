                    ...
                    <div class="col-lg-6">
                        <div class="login_box_img">
                            ...
                            <div class="hover">
                                ...
                                <a class="primary-btn" href="sign-up-user">Create an Account</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <form class="row login_form" action="login" method="post" id="contactForm" >
                                ...
                                <div class="col-md-12 form-group">
                                    <div class="creat_account">
                                        <input type="checkbox" id="f-option2 form-check-input" id="exampleCheck1" name="remember">
                                        <label for="f-option2">Keep me logged in</label>
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="submit" class="primary-btn">Log In</button>
                                    <a href="sign-up-user">Don't have an account?</a>
                                </div>
                            </form>
                        </div>
                    </div>
