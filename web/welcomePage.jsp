...
<%-- 
    ...
    Created on : Jun 21, 2022, 11:27:25 AM
    Author     : toten
--%>
            ...
            <div class="single-product-slider">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <c:forEach var="D" items="${listProduct2}">
                            <div class="col-lg-3 col-md-6">
                                <div class="single-product">
                                    <a href="detail?productId=${D.productID}">
                                        <img class="img-fluid" style="height: 19rem" src="${D.getImageUrl()}" alt="">
                                    </a>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="price">
                                            <h6>${D.getPrice()}$</h6>
                                            <h6 class="l-through">${D.getPrice()+40}$</h6>
                                        </div>
                                        <div class="prd-bottom">

                                            <a class="social-info" onclick="addToCartAsync(${D.productID})" style="cursor: pointer">
